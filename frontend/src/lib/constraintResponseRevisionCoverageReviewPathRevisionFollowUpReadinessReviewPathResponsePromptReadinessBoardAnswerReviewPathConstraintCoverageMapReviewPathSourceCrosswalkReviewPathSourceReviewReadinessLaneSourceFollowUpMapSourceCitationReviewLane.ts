import type {
  ...
  ,
  ...
  ,
  ,
...
const stage128IdPrefix = `${stage127IdPrefix}-evidence-gap-readiness-matrix`;
const stage129IdPrefix = `${stage128IdPrefix}-evidence-gap-follow-up-review-path`;
...
export function (
  ...
  const evidenceGapReadinessRows =
    evidenceCheckReviewPath.evidenceCheckReviewPathSteps.map((step) =>
      buildStage128EvidenceGapReadinessRow(
        step,
  ...
  const staticFollowUpPromptCards =
    evidenceCheckReviewPath.staticCitationGapCueCards.map((card) =>
      buildStage128StaticFollowUpPromptCard(
        card,
  ...
  return {
    ...
    summary: {
      ...
      defaultEvidenceGapReadinessContext: {
        ...
        sourceStage127EvidenceCheckReviewPathSummary:
          evidenceCheckReviewPath.summary.summary,
        sourceStage127DefaultEvidenceCheckReviewContext: defaultStage127Context,
      },
      informationalOnly: true,
      nonActionable: true,
      nonPersistent: true,
...
export function (
  ...
  const followUpReviewPathSteps =
    evidenceGapReadinessMatrix.evidenceGapReadinessRows.map((row) =>
      buildStage129FollowUpReviewPathStep(
        row,
  ...
  const staticReadinessCueCards =
    evidenceGapReadinessMatrix.staticFollowUpPromptCards.map((card) =>
      buildStage129StaticReadinessCueCard(
        card,
  ...
  return {
    ...
    summary: {
      ...
      defaultFollowUpReviewContext: {
        ...
        sourceStage128EvidenceGapReadinessMatrixSummary:
          evidenceGapReadinessMatrix.summary.summary,
        sourceStage128DefaultEvidenceGapReadinessContext: defaultStage128Context,
      },
      informationalOnly: true,
      nonActionable: true,
      nonPersistent: true,
...
function buildStage128EvidenceGapReadinessRow(
  ...
  const matchedStaticCitationGapCueCards = staticCitationGapCueCards.filter(
    (card) => stage128StepMatchesCitationGapCueCard(evidenceCheckReviewPathStep, card),
  );
  const sourceStaticCitationGapCueCardIds = matchedStaticCitationGapCueCards.map(
    (card) => card.staticCitationGapCueCardId,
  );
  const readinessLabels = buildStage128RowReadinessLabels(
    evidenceCheckReviewPathStep,
    matchedStaticCitationGapCueCards,
  );
  const followUpPromptLabels = buildStage128RowFollowUpPromptLabels(
    evidenceCheckReviewPathStep,
    matchedStaticCitationGapCueCards,
  );
  const evidenceGapReadinessRowId =
    `${stage128IdPrefix}:row:${sourceEvidenceCheckReviewPathStepId}`;
  ...
  return {
    ...
    readinessText:
      `Evidence-gap readiness row ${sourceEvidenceCheckReviewPathStepId}: carry Stage 127 evidence-check review path step ${sourceEvidenceCheckReviewPathStepId}, Stage 127 static citation-gap cue cards ${joinOrNone(sourceStaticCitationGapCueCardIds)}, Stage 126 static evidence-check prompt card ${evidenceCheckReviewPathStep.sourceStaticEvidenceCheckPromptCardId}, Stage 126 citation-review lane rows ${joinOrNone(evidenceCheckReviewPathStep.sourceCitationReviewLaneRowIds)}, Stage 125 source follow-up map entry ${evidenceCheckReviewPathStep.sourceSourceFollowUpMapEntryId}, Stage 125 citation prompt cards ${joinOrNone(evidenceCheckReviewPathStep.sourceStaticCitationCheckPromptCardIds)}, Stage 124 source-readiness row ${evidenceCheckReviewPathStep.sourceSourceReviewReadinessLaneRowId}, Stage 124 cue cards ${joinOrNone(evidenceCheckReviewPathStep.sourceStaticSourceFollowUpCueCardIds)}, Stage 123 source-review path step ${evidenceCheckReviewPathStep.sourceSourceReviewPathStepId}, Stage 123 static source-review prompt cards ${joinOrNone(evidenceCheckReviewPathStep.sourceStaticSourceReviewPromptCardIds)}, Stage 122 source-crosswalk row ${evidenceCheckReviewPathStep.sourceCrosswalkRowId}, Stage 122 static review-check cards ${joinOrNone(evidenceCheckReviewPathStep.sourceStaticReviewCheckCardIds)}, Stage 121 review-path step ${evidenceCheckReviewPathStep.sourceConstraintCoverageReviewPathStepId}, Stage 121 response-review prompt cards ${joinOrNone(evidenceCheckReviewPathStep.sourceStaticResponsePromptCardIds)}, Stage 120 constraint-coverage row ${evidenceCheckReviewPathStep.sourceConstraintCoverageRowId}, Stage 120 response-note prompt cards ${joinOrNone(evidenceCheckReviewPathStep.sourceStaticResponseNotePromptCardIds)}, Stage 119 answer-review step ${evidenceCheckReviewPathStep.sourceAnswerReviewPathStepId}, Stage 119 constraint-note cards ${joinOrNone(evidenceCheckReviewPathStep.sourceStaticConstraintNoteCardIds)}, Stage 118 answer-check card ${evidenceCheckReviewPathStep.sourceStaticAnswerCheckCardId}, Stage 118 readiness rows ${joinOrNone(evidenceCheckReviewPathStep.sourceResponsePromptReadinessRowIds)}, Stage 117 review-path steps ${joinOrNone(evidenceCheckReviewPathStep.sourceRevisionFollowUpReadinessReviewPathStepIds)}, Stage 116 readiness rows ${joinOrNone(evidenceCheckReviewPathStep.sourceRevisionFollowUpReadinessRowIds)}, Stage 116 response-check card ${evidenceCheckReviewPathStep.sourceStaticResponseCheckCardId}, Stage 115 through Stage 64 lineage ids ${joinOrNone([
        ...evidenceCheckReviewPathStep.sourceStaticRevisionFollowUpPromptCardIds,
        ...evidenceCheckReviewPathStep.sourceRevisionCoverageReviewPathStepIds,
        ...evidenceCheckReviewPathStep.sourceRevisionCoverageRowIds,
        ...evidenceCheckReviewPathStep.sourceStaticRevisionCheckCardIds,
        ...evidenceCheckReviewPathStep.sourceStaticRevisionPromptCardIds,
        ...evidenceCheckReviewPathStep.sourceStaticDraftCheckCardIds,
        ...evidenceCheckReviewPathStep.sourceStaticResponseCueCardIds,
        ...evidenceCheckReviewPathStep.sourceStaticReviewPromptCardIds,
        ...evidenceCheckReviewPathStep.sourceStaticReadinessCueCardIds,
        ...evidenceCheckReviewPathStep.sourceStaticFollowUpPromptCardIds,
        ...evidenceCheckReviewPathStep.sourceStaticCitationGapCueCardIds,
        ...evidenceCheckReviewPathStep.sourceEvidenceCheckReviewPathStepIds,
        ...evidenceCheckReviewPathStep.sourceEvidenceGapReadinessRowIds,
        ...evidenceCheckReviewPathStep.sourceFollowUpReviewPathStepIds,
      ])}, anchors ${joinOrNone(evidenceCheckReviewPathStep.sourceLocalAnchorHrefs)}, callbacks ${joinOrNone(evidenceCheckReviewPathStep.evidenceCallbackIds)}, gap prompts ${joinOrNone(evidenceCheckReviewPathStep.gapDiscussionPointIds)}, deferred reminders ${joinOrNone(evidenceCheckReviewPathStep.deferredScopeReminderIds)}, readiness labels ${joinOrNone(readinessLabels)}, follow-up prompt labels ${joinOrNone(followUpPromptLabels)}, and Stage 127 evidence-check text "${displayCarriedText(evidenceCheckReviewPathStep.evidenceCheckReviewText)}" as deterministic manual evidence-gap readiness context only.`,
    followUpPromptText:
      `Static follow-up prompt context for readiness row ${sourceEvidenceCheckReviewPathStepId}: compare Stage 127 evidence-check review path step ${sourceEvidenceCheckReviewPathStepId}, Stage 127 citation-gap cue cards ${joinOrNone(sourceStaticCitationGapCueCardIds)}, matched Stage 126 citation-review rows ${joinOrNone(evidenceCheckReviewPathStep.sourceCitationReviewLaneRowIds)}, Stage 125 citation prompt cards ${joinOrNone(evidenceCheckReviewPathStep.sourceStaticCitationCheckPromptCardIds)}, anchors ${joinOrNone(evidenceCheckReviewPathStep.sourceLocalAnchorHrefs)}, callbacks ${joinOrNone(evidenceCheckReviewPathStep.evidenceCallbackIds)}, gap prompts ${joinOrNone(evidenceCheckReviewPathStep.gapDiscussionPointIds)}, deferred reminders ${joinOrNone(evidenceCheckReviewPathStep.deferredScopeReminderIds)}, readiness labels ${joinOrNone(readinessLabels)}, and Stage 127 citation-gap cue text "${displayCarriedText(evidenceCheckReviewPathStep.citationGapCueText)}" before drafting outside the app without saved reviewer answers, answer drafts, reviewer notes, response notes, source selections, citation selections, evidence-check selections, evidence-gap readiness state, priorities, rankings, scores, certifications, owners, routes, exports, signoff, meetings, packages, task launchers, runnable checklists, or commands.`,
    staticNonGoalContext:
      "Static Stage 128 evidence-gap readiness row context: manual review-path, citation-gap, source-lineage, anchor, callback, gap-prompt, and deferred-reminder comparison only; no saved reviewer answers, saved answer drafts, saved reviewer notes, saved response notes, saved source selections, saved citation selections, saved evidence-check selections, saved evidence-gap readiness state, persistence, routing, scoring, ranking, certification, owner assignment, meeting workflow, exports, handoff packages, task launchers, runnable checklists, or commands.",
    staticNonGoalFlags: staticStage128NonGoalFlags(
      evidenceCheckReviewPathStep.staticNonGoalFlags,
    ),
  };
}

function buildStage128StaticFollowUpPromptCard(
  staticCitationGapCueCard: ,
  ...
  const matchedEvidenceCheckReviewPathSteps = evidenceCheckReviewPathSteps.filter(
    (step) => stage128StepMatchesCitationGapCueCard(step, staticCitationGapCueCard),
  );
  const sourceEvidenceCheckReviewPathStepIds =
    matchedEvidenceCheckReviewPathSteps.map(
      (step) => step.evidenceCheckReviewPathStepId,
    );
  const readinessLabels = buildStage128CardReadinessLabels(
    staticCitationGapCueCard,
    matchedEvidenceCheckReviewPathSteps,
  );
  const followUpPromptLabels = buildStage128CardFollowUpPromptLabels(
    staticCitationGapCueCard,
    matchedEvidenceCheckReviewPathSteps,
  );
  const staticFollowUpPromptCardId =
    `${stage128IdPrefix}:static-follow-up-prompt:${sourceStaticCitationGapCueCardId}`;
  ...
  return {
    ...
    followUpPromptLabels,
    readinessText:
      `Evidence-gap readiness cue ${sourceStaticCitationGapCueCardId}: carry Stage 127 static citation-gap cue card ${sourceStaticCitationGapCueCardId}, Stage 127 evidence-check review path steps ${joinOrNone(sourceEvidenceCheckReviewPathStepIds)}, Stage 126 citation-review lane row ${staticCitationGapCueCard.sourceCitationReviewLaneRowId}, Stage 126 static evidence-check prompt cards ${joinOrNone(staticCitationGapCueCard.sourceStaticEvidenceCheckPromptCardIds)}, Stage 125 citation prompt card ${staticCitationGapCueCard.sourceStaticCitationCheckPromptCardId}, Stage 125 source follow-up map entries ${joinOrNone(staticCitationGapCueCard.sourceSourceFollowUpMapEntryIds)}, Stage 124 readiness rows ${joinOrNone(staticCitationGapCueCard.sourceSourceReviewReadinessLaneRowIds)}, Stage 124 cue card ${staticCitationGapCueCard.sourceStaticSourceFollowUpCueCardId}, Stage 123 source-review path steps ${joinOrNone(staticCitationGapCueCard.sourceSourceReviewPathStepIds)}, Stage 123 static source-review prompt cards ${joinOrNone(staticCitationGapCueCard.sourceStaticSourceReviewPromptCardIds)}, Stage 122 source-crosswalk rows ${joinOrNone(staticCitationGapCueCard.sourceCrosswalkRowIds)}, Stage 122 static review-check cards ${joinOrNone(staticCitationGapCueCard.sourceStaticReviewCheckCardIds)}, Stage 121 review-path steps ${joinOrNone(staticCitationGapCueCard.sourceConstraintCoverageReviewPathStepIds)}, Stage 121 response-review prompt cards ${joinOrNone(staticCitationGapCueCard.sourceStaticResponsePromptCardIds)}, Stage 120 constraint-coverage rows ${joinOrNone(staticCitationGapCueCard.sourceConstraintCoverageRowIds)}, Stage 120 response-note prompt cards ${joinOrNone(staticCitationGapCueCard.sourceStaticResponseNotePromptCardIds)}, Stage 119 answer-review steps ${joinOrNone(staticCitationGapCueCard.sourceAnswerReviewPathStepIds)}, Stage 119 constraint-note cards ${joinOrNone(staticCitationGapCueCard.sourceStaticConstraintNoteCardIds)}, Stage 118 answer-check cards ${joinOrNone(staticCitationGapCueCard.sourceStaticAnswerCheckCardIds)}, Stage 118 readiness rows ${joinOrNone(staticCitationGapCueCard.sourceResponsePromptReadinessRowIds)}, Stage 117 review-path steps ${joinOrNone(staticCitationGapCueCard.sourceRevisionFollowUpReadinessReviewPathStepIds)}, Stage 116 readiness rows ${joinOrNone(staticCitationGapCueCard.sourceRevisionFollowUpReadinessRowIds)}, anchors ${joinOrNone(staticCitationGapCueCard.sourceLocalAnchorHrefs)}, callbacks ${joinOrNone(staticCitationGapCueCard.evidenceCallbackIds)}, gap prompts ${joinOrNone(staticCitationGapCueCard.gapDiscussionPointIds)}, deferred reminders ${joinOrNone(staticCitationGapCueCard.deferredScopeReminderIds)}, readiness labels ${joinOrNone(readinessLabels)}, and Stage 127 citation-gap cue text "${displayCarriedText(staticCitationGapCueCard.citationGapCueText)}" as deterministic manual evidence-gap readiness context only.`,
    followUpPromptText:
      `Static follow-up prompt card ${sourceStaticCitationGapCueCardId}: inspect Stage 127 static citation-gap cue ${sourceStaticCitationGapCueCardId}, matched Stage 127 evidence-check review path steps ${joinOrNone(sourceEvidenceCheckReviewPathStepIds)}, Stage 126 citation-review lane row ${staticCitationGapCueCard.sourceCitationReviewLaneRowId}, Stage 126 static evidence-check prompt cards ${joinOrNone(staticCitationGapCueCard.sourceStaticEvidenceCheckPromptCardIds)}, Stage 125 citation prompt ${staticCitationGapCueCard.sourceStaticCitationCheckPromptCardId}, Stage 125 follow-up entries ${joinOrNone(staticCitationGapCueCard.sourceSourceFollowUpMapEntryIds)}, local anchors ${joinOrNone(staticCitationGapCueCard.sourceLocalAnchorHrefs)}, callbacks ${joinOrNone(staticCitationGapCueCard.evidenceCallbackIds)}, gap prompts ${joinOrNone(staticCitationGapCueCard.gapDiscussionPointIds)}, deferred reminders ${joinOrNone(staticCitationGapCueCard.deferredScopeReminderIds)}, follow-up prompt labels ${joinOrNone(followUpPromptLabels)}, and Stage 127 evidence-check text "${displayCarriedText(staticCitationGapCueCard.evidenceCheckReviewText)}" before drafting outside the app without saved reviewer answers, answer drafts, reviewer notes, response notes, source selections, citation selections, evidence-check selections, evidence-gap readiness state, priorities, rankings, scores, certifications, owners, routes, exports, signoff, meetings, packages, task launchers, runnable checklists, or commands.`,
    staticNonGoalContext:
      "Static Stage 128 evidence-gap follow-up prompt context: manual citation-gap, evidence-check, source-lineage, anchor, callback, gap-prompt, and deferred-reminder review only; no saved reviewer answers, saved answer drafts, saved reviewer notes, saved response notes, saved source selections, saved citation selections, saved evidence-check selections, saved evidence-gap readiness state, persistence, routing, scoring, ranking, certification, owner assignment, meeting workflow, exports, handoff packages, task launchers, runnable checklists, or commands.",
    staticNonGoalFlags: staticStage128NonGoalFlags(
...
function buildStage129FollowUpReviewPathStep(
  evidenceGapReadinessRow: ,
  ...
  const matchedStaticFollowUpPromptCards = staticFollowUpPromptCards.filter(
    (card) => stage129RowMatchesStaticFollowUpPromptCard(evidenceGapReadinessRow, card),
  );
  const sourceStaticFollowUpPromptCardIds =
    matchedStaticFollowUpPromptCards.map((card) => card.staticFollowUpPromptCardId);
  const followUpReviewLabels = buildStage129StepFollowUpReviewLabels(
    evidenceGapReadinessRow,
    matchedStaticFollowUpPromptCards,
  );
  const readinessCueLabels = buildStage129StepReadinessCueLabels(
    evidenceGapReadinessRow,
    matchedStaticFollowUpPromptCards,
  );
  const followUpReviewPathStepId =
    `${stage129IdPrefix}:step:${sourceEvidenceGapReadinessRowId}`;
  ...
  return {
    ...
    readinessCueLabels,
    followUpReviewText:
      `Evidence-gap follow-up review step ${sourceEvidenceGapReadinessRowId}: carry Stage 128 evidence-gap readiness row ${sourceEvidenceGapReadinessRowId}, Stage 128 static follow-up prompt cards ${joinOrNone(sourceStaticFollowUpPromptCardIds)}, Stage 127 evidence-check review path step ${evidenceGapReadinessRow.sourceEvidenceCheckReviewPathStepId}, Stage 127 static citation-gap cue cards ${joinOrNone(evidenceGapReadinessRow.sourceStaticCitationGapCueCardIds)}, Stage 126 static evidence-check prompt card ${evidenceGapReadinessRow.sourceStaticEvidenceCheckPromptCardId}, Stage 126 citation-review lane rows ${joinOrNone(evidenceGapReadinessRow.sourceCitationReviewLaneRowIds)}, Stage 125 source follow-up map entry ${evidenceGapReadinessRow.sourceSourceFollowUpMapEntryId}, Stage 125 citation prompt cards ${joinOrNone(evidenceGapReadinessRow.sourceStaticCitationCheckPromptCardIds)}, Stage 124 source-readiness row ${evidenceGapReadinessRow.sourceSourceReviewReadinessLaneRowId}, Stage 124 cue cards ${joinOrNone(evidenceGapReadinessRow.sourceStaticSourceFollowUpCueCardIds)}, Stage 123 source-review path step ${evidenceGapReadinessRow.sourceSourceReviewPathStepId}, Stage 123 static source-review prompt cards ${joinOrNone(evidenceGapReadinessRow.sourceStaticSourceReviewPromptCardIds)}, Stage 122 source-crosswalk row ${evidenceGapReadinessRow.sourceCrosswalkRowId}, Stage 122 static review-check cards ${joinOrNone(evidenceGapReadinessRow.sourceStaticReviewCheckCardIds)}, Stage 121 review-path step ${evidenceGapReadinessRow.sourceConstraintCoverageReviewPathStepId}, Stage 121 response-review prompt cards ${joinOrNone(evidenceGapReadinessRow.sourceStaticResponsePromptCardIds)}, Stage 120 constraint-coverage row ${evidenceGapReadinessRow.sourceConstraintCoverageRowId}, Stage 120 response-note prompt cards ${joinOrNone(evidenceGapReadinessRow.sourceStaticResponseNotePromptCardIds)}, Stage 119 answer-review step ${evidenceGapReadinessRow.sourceAnswerReviewPathStepId}, Stage 119 constraint-note cards ${joinOrNone(evidenceGapReadinessRow.sourceStaticConstraintNoteCardIds)}, Stage 118 answer-check card ${evidenceGapReadinessRow.sourceStaticAnswerCheckCardId}, Stage 118 readiness rows ${joinOrNone(evidenceGapReadinessRow.sourceResponsePromptReadinessRowIds)}, Stage 117 review-path steps ${joinOrNone(evidenceGapReadinessRow.sourceRevisionFollowUpReadinessReviewPathStepIds)}, Stage 116 readiness rows ${joinOrNone(evidenceGapReadinessRow.sourceRevisionFollowUpReadinessRowIds)}, Stage 116 through Stage 64 lineage ids ${joinOrNone([
        ...evidenceGapReadinessRow.sourceStaticRevisionFollowUpPromptCardIds,
        ...evidenceGapReadinessRow.sourceRevisionCoverageReviewPathStepIds,
        ...evidenceGapReadinessRow.sourceRevisionCoverageRowIds,
        ...evidenceGapReadinessRow.sourceStaticRevisionCheckCardIds,
        ...evidenceGapReadinessRow.sourceStaticRevisionPromptCardIds,
        ...evidenceGapReadinessRow.sourceStaticDraftCheckCardIds,
        ...evidenceGapReadinessRow.sourceStaticResponseCueCardIds,
        ...evidenceGapReadinessRow.sourceStaticReviewPromptCardIds,
        ...evidenceGapReadinessRow.sourceStaticReadinessCueCardIds,
        ...evidenceGapReadinessRow.sourceStaticFollowUpPromptCardIds,
        ...evidenceGapReadinessRow.sourceStaticCitationGapCueCardIds,
        ...evidenceGapReadinessRow.sourceEvidenceCheckReviewPathStepIds,
        ...evidenceGapReadinessRow.sourceEvidenceGapReadinessRowIds,
        ...evidenceGapReadinessRow.sourceFollowUpReviewPathStepIds,
      ])}, anchors ${joinOrNone(evidenceGapReadinessRow.sourceLocalAnchorHrefs)}, callbacks ${joinOrNone(evidenceGapReadinessRow.evidenceCallbackIds)}, gap prompts ${joinOrNone(evidenceGapReadinessRow.gapDiscussionPointIds)}, deferred reminders ${joinOrNone(evidenceGapReadinessRow.deferredScopeReminderIds)}, follow-up review labels ${joinOrNone(followUpReviewLabels)}, readiness cue labels ${joinOrNone(readinessCueLabels)}, Stage 128 readiness text "${displayCarriedText(evidenceGapReadinessRow.readinessText)}", and Stage 128 prompt text "${displayCarriedText(evidenceGapReadinessRow.followUpPromptText)}" as deterministic manual follow-up review context only.`,
    readinessCueText:
      `Static readiness cue context for Stage 129 follow-up review step ${sourceEvidenceGapReadinessRowId}: compare Stage 128 readiness row ${sourceEvidenceGapReadinessRowId}, Stage 128 static follow-up prompt cards ${joinOrNone(sourceStaticFollowUpPromptCardIds)}, Stage 127 evidence-check review path step ${evidenceGapReadinessRow.sourceEvidenceCheckReviewPathStepId}, Stage 127 citation-gap cues ${joinOrNone(evidenceGapReadinessRow.sourceStaticCitationGapCueCardIds)}, anchors ${joinOrNone(evidenceGapReadinessRow.sourceLocalAnchorHrefs)}, callbacks ${joinOrNone(evidenceGapReadinessRow.evidenceCallbackIds)}, gap prompts ${joinOrNone(evidenceGapReadinessRow.gapDiscussionPointIds)}, deferred reminders ${joinOrNone(evidenceGapReadinessRow.deferredScopeReminderIds)}, readiness labels ${joinOrNone(evidenceGapReadinessRow.readinessLabels)}, and follow-up prompt labels ${joinOrNone(evidenceGapReadinessRow.followUpPromptLabels)} before drafting outside the app without saved reviewer answers, answer drafts, reviewer notes, response notes, source selections, citation selections, evidence-check selections, evidence-gap readiness selections, evidence-gap follow-up selections, follow-up review path state, priorities, rankings, scores, certifications, owners, routes, exports, signoff, meetings, packages, task launchers, runnable checklists, or commands.`,
    staticNonGoalContext:
      "Static Stage 129 evidence-gap follow-up review path context: manual readiness-row, prompt-card, source-lineage, anchor, callback, gap-prompt, and deferred-reminder comparison only; no saved reviewer answers, saved answer drafts, saved reviewer notes, saved response notes, saved source selections, saved citation selections, saved evidence-check selections, saved evidence-gap readiness selections, saved evidence-gap follow-up selections, saved follow-up review path state, persistence, routing, scoring, ranking, certification, owner assignment, meeting workflow, exports, handoff packages, task launchers, runnable checklists, or commands.",
    staticNonGoalFlags: staticStage129NonGoalFlags(
      evidenceGapReadinessRow.staticNonGoalFlags,
    ),
  };
}

function buildStage129StaticReadinessCueCard(
  staticFollowUpPromptCard: ,
  evidenceGapReadinessRows: [],
):  {
  ...
  const matchedEvidenceGapReadinessRows = evidenceGapReadinessRows.filter((row) =>
    stage129RowMatchesStaticFollowUpPromptCard(row, staticFollowUpPromptCard),
  );
  const sourceEvidenceGapReadinessRowIds =
    matchedEvidenceGapReadinessRows.map((row) => row.evidenceGapReadinessRowId);
  const followUpReviewLabels = buildStage129CardFollowUpReviewLabels(
    staticFollowUpPromptCard,
    matchedEvidenceGapReadinessRows,
  );
  const readinessCueLabels = buildStage129CardReadinessCueLabels(
    staticFollowUpPromptCard,
    matchedEvidenceGapReadinessRows,
  );
  const staticReadinessCueCardId =
    `${stage129IdPrefix}:static-readiness-cue:${sourceStaticFollowUpPromptCardId}`;
  ...
  return {
    ...
    readinessCueLabels,
    followUpReviewText:
      `Follow-up review cue ${sourceStaticFollowUpPromptCardId}: carry Stage 128 static follow-up prompt card ${sourceStaticFollowUpPromptCardId}, Stage 128 evidence-gap readiness rows ${joinOrNone(sourceEvidenceGapReadinessRowIds)}, Stage 127 static citation-gap cue card ${staticFollowUpPromptCard.sourceStaticCitationGapCueCardId}, Stage 127 evidence-check review path steps ${joinOrNone(staticFollowUpPromptCard.sourceEvidenceCheckReviewPathStepIds)}, Stage 126 citation-review lane row ${staticFollowUpPromptCard.sourceCitationReviewLaneRowId}, Stage 126 static evidence-check prompt cards ${joinOrNone(staticFollowUpPromptCard.sourceStaticEvidenceCheckPromptCardIds)}, Stage 125 citation prompt card ${staticFollowUpPromptCard.sourceStaticCitationCheckPromptCardId}, Stage 125 source follow-up map entries ${joinOrNone(staticFollowUpPromptCard.sourceSourceFollowUpMapEntryIds)}, Stage 124 readiness rows ${joinOrNone(staticFollowUpPromptCard.sourceSourceReviewReadinessLaneRowIds)}, Stage 123 source-review path steps ${joinOrNone(staticFollowUpPromptCard.sourceSourceReviewPathStepIds)}, Stage 122 source-crosswalk rows ${joinOrNone(staticFollowUpPromptCard.sourceCrosswalkRowIds)}, Stage 121 review-path steps ${joinOrNone(staticFollowUpPromptCard.sourceConstraintCoverageReviewPathStepIds)}, Stage 120 constraint-coverage rows ${joinOrNone(staticFollowUpPromptCard.sourceConstraintCoverageRowIds)}, Stage 119 answer-review steps ${joinOrNone(staticFollowUpPromptCard.sourceAnswerReviewPathStepIds)}, Stage 118 readiness rows ${joinOrNone(staticFollowUpPromptCard.sourceResponsePromptReadinessRowIds)}, Stage 117 review path steps ${joinOrNone(staticFollowUpPromptCard.sourceRevisionFollowUpReadinessReviewPathStepIds)}, anchors ${joinOrNone(staticFollowUpPromptCard.sourceLocalAnchorHrefs)}, callbacks ${joinOrNone(staticFollowUpPromptCard.evidenceCallbackIds)}, gap prompts ${joinOrNone(staticFollowUpPromptCard.gapDiscussionPointIds)}, deferred reminders ${joinOrNone(staticFollowUpPromptCard.deferredScopeReminderIds)}, follow-up review labels ${joinOrNone(followUpReviewLabels)}, and Stage 128 follow-up prompt text "${displayCarriedText(staticFollowUpPromptCard.followUpPromptText)}" as deterministic manual follow-up review context only.`,
    readinessCueText:
      `Static readiness cue card ${sourceStaticFollowUpPromptCardId}: inspect Stage 128 static follow-up prompt card ${sourceStaticFollowUpPromptCardId}, Stage 128 readiness rows ${joinOrNone(sourceEvidenceGapReadinessRowIds)}, Stage 127 citation-gap cue ${staticFollowUpPromptCard.sourceStaticCitationGapCueCardId}, Stage 126 citation-review lane row ${staticFollowUpPromptCard.sourceCitationReviewLaneRowId}, Stage 125 citation prompt ${staticFollowUpPromptCard.sourceStaticCitationCheckPromptCardId}, Stage 124 readiness rows ${joinOrNone(staticFollowUpPromptCard.sourceSourceReviewReadinessLaneRowIds)}, Stage 123 source-review path steps ${joinOrNone(staticFollowUpPromptCard.sourceSourceReviewPathStepIds)}, Stage 122 crosswalk rows ${joinOrNone(staticFollowUpPromptCard.sourceCrosswalkRowIds)}, anchors ${joinOrNone(staticFollowUpPromptCard.sourceLocalAnchorHrefs)}, callbacks ${joinOrNone(staticFollowUpPromptCard.evidenceCallbackIds)}, gap prompts ${joinOrNone(staticFollowUpPromptCard.gapDiscussionPointIds)}, deferred reminders ${joinOrNone(staticFollowUpPromptCard.deferredScopeReminderIds)}, readiness cue labels ${joinOrNone(readinessCueLabels)}, and Stage 128 readiness text "${displayCarriedText(staticFollowUpPromptCard.readinessText)}" before drafting outside the app without saved reviewer answers, answer drafts, reviewer notes, response notes, source selections, citation selections, evidence-check selections, evidence-gap readiness selections, evidence-gap follow-up selections, follow-up review path state, priorities, rankings, scores, certifications, owners, routes, exports, signoff, meetings, packages, task launchers, runnable checklists, or commands.`,
    staticNonGoalContext:
      "Static Stage 129 readiness cue context: manual Stage 128 prompt-card, readiness-row, source-lineage, anchor, callback, gap-prompt, and deferred-reminder review only; no saved reviewer answers, saved answer drafts, saved reviewer notes, saved response notes, saved source selections, saved citation selections, saved evidence-check selections, saved evidence-gap readiness selections, saved evidence-gap follow-up selections, saved follow-up review path state, persistence, routing, scoring, ranking, certification, owner assignment, meeting workflow, exports, handoff packages, task launchers, runnable checklists, or commands.",
    staticNonGoalFlags: staticStage129NonGoalFlags(
...
function buildStage128Counts(
  evidenceGapReadinessRows: [],
  staticFollowUpPromptCards: [],
  evidenceCheckReviewPath: ,
): ["counts"] {
...
function stage128StepMatchesCitationGapCueCard(
  evidenceCheckReviewPathStep: ,
  staticCitationGapCueCard: ,
): boolean {
  return (
...
function stage129RowMatchesStaticFollowUpPromptCard(
  evidenceGapReadinessRow: ,
  staticFollowUpPromptCard: ,
): boolean {
  return (
...
function buildStage128RowReadinessLabels(
  evidenceCheckReviewPathStep: ,
  matchedStaticCitationGapCueCards: [],
): string[] {
  const labels = [
    "evidence-gap readiness matrix row",
    "Stage 127 evidence-check review path carry-forward",
  ];

  if (matchedStaticCitationGapCueCards.length) {
    labels.push("matched Stage 127 citation-gap cue context");
  }

  if (evidenceCheckReviewPathStep.evidenceCheckReviewLabels.length) {
    labels.push("Stage 127 evidence-check label carry-forward");
  }

  return labels;
}

function buildStage128RowFollowUpPromptLabels(
  evidenceCheckReviewPathStep: ,
  matchedStaticCitationGapCueCards: [],
): string[] {
  const labels = [
...
function buildStage128CardReadinessLabels(
  staticCitationGapCueCard: ,
  matchedEvidenceCheckReviewPathSteps: [],
): string[] {
  const labels = [
    "citation-gap readiness carry-forward",
    "Stage 127 static citation-gap cue card",
  ];
  ...
  if (staticCitationGapCueCard.evidenceCheckReviewLabels.length) {
    labels.push("Stage 127 evidence-check cue label carry-forward");
  }

  return labels;
}

function buildStage128CardFollowUpPromptLabels(
  staticCitationGapCueCard: ,
  matchedEvidenceCheckReviewPathSteps: [],
): string[] {
  const labels = [
    "static follow-up prompt card",
    "Stage 127 citation-gap follow-up context",
  ];
...
function buildStage129StepFollowUpReviewLabels(
  evidenceGapReadinessRow: ,
  matchedStaticFollowUpPromptCards: [],
): string[] {
  const labels = [
    "evidence-gap follow-up review path step",
    "Stage 128 readiness row carry-forward",
  ];

  if (matchedStaticFollowUpPromptCards.length) {
    labels.push("matched Stage 128 static follow-up prompt context");
  }

  if (evidenceGapReadinessRow.followUpPromptLabels.length) {
    labels.push("Stage 128 follow-up prompt label carry-forward");
  }

  return labels;
}

function buildStage129StepReadinessCueLabels(
  evidenceGapReadinessRow: ,
  matchedStaticFollowUpPromptCards: [],
): string[] {
  const labels = [
    "static readiness cue context",
    "Stage 128 readiness cue carry-forward",
  ];
...
function buildStage129CardFollowUpReviewLabels(
  staticFollowUpPromptCard: ,
  matchedEvidenceGapReadinessRows: [],
): string[] {
  const labels = [
    "static readiness follow-up review context",
    "Stage 128 static follow-up prompt card",
  ];
  ...
  if (staticFollowUpPromptCard.followUpPromptLabels.length) {
    labels.push("Stage 128 follow-up prompt cue label carry-forward");
  }

  return labels;
}

function buildStage129CardReadinessCueLabels(
  staticFollowUpPromptCard: ,
  matchedEvidenceGapReadinessRows: [],
): string[] {
  const labels = [
    "static readiness cue card",
    "Stage 128 follow-up prompt readiness cue",
  ];
...
function staticStage128NonGoalFlags(
  sourceFlags: ,
):  {
  return {
    ...sourceFlags,
...
function staticStage129NonGoalFlags(
  sourceFlags: ,
):  {
  return {
    ...sourceFlags,
