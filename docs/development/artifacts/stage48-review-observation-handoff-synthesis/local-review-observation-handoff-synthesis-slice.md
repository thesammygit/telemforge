# Stage 48 Local Review Observation Handoff Synthesis Slice

## Contract

Stage 48 adds a deterministic local
`telemforge.review_observation_handoff_synthesis.v1` map over the Stage 47
`reviewObservationHandoffCalibration` output. Synthesis rows preserve Stage 47
calibration card order, and static relay notes preserve Stage 47 static
alignment note order.

The surface is static manual-review context only. It is not saved synthesis
notes, saved synthesis state, saved calibration state, saved drift state,
reviewer progress, persistence, local storage, routes, exports, signoff, audit
...
- `frontend/src/lib/reviewObservationHandoffSynthesis.ts`
- `frontend/src/features/mission-console/types.ts`
- `frontend/src/features/mission-console/consoleViewModel.ts`
- `frontend/src/features/mission-console/MissionConsole.tsx`
- `frontend/src/styles/global.css`
- `tests/frontend/reviewObservationHandoffSynthesis.test.ts`
- `tests/frontend/consoleViewModel.test.ts`

## Human Test Gate

Open the mission console in fixture mode, find the Stage 48 synthesis map near
the Stage 47 calibration board, confirm synthesis row order mirrors Stage 47
calibration card order, confirm static relay notes mirror Stage 47 alignment
...
Saved synthesis notes, saved reviewer state, persistence, local storage,
