...
- derives ordered evidence-check review path steps from Stage 106 static
  evidence-check prompt cards;
- derives static citation-gap cue cards from Stage 106 citation-review lane
  rows;
- preserves Stage 106 evidence prompt order and citation-review row order;
- carries the Stage 106 default citation-review context into the Stage 107
  summary;
- exposes Stage 106 evidence-check prompt ids, Stage 106 citation-review row
  ids, Stage 105 source follow-up map entry ids, Stage 105 citation prompt ids,
...
Recommended: start with Option A. Stage 107 should make Stage 106 static
...
Option A: compact evidence-check review path panel near the Stage 106 panel

- keeps evidence-check context adjacent to the Stage 106 citation-review lane
  it derives from;
...
Recommended: Option A. The Stage 107 evidence-check review path should be a
...
- add a deterministic local helper,
  ...
  over the Stage 106 source citation-review lane view;
- define compact Stage 107 types in
...
- wire the evidence-check review path into
  ...
  106 source citation-review lane is built, without changing fixture or
  local-live boundaries;
- surface a compact Stage 107 evidence-check review path/static citation-gap
...
- add a public-safe Stage 107 artifact under
  `docs/development/artifacts/stage107-constraint-response-evidence-check-review-path/`
...
2. find the Stage 107 evidence-check review path near the Stage 106 source
   citation-review lane;
3. confirm evidence-check review path step order preserves Stage 106 static
   evidence-check prompt card order;
4. confirm static citation-gap cue card order preserves Stage 106
   citation-review lane row order;
5. confirm the default Stage 107 review context mirrors the Stage 106 default
   citation-review context;
6. confirm each review path step shows Stage 106 evidence prompt ids, Stage 106
   citation-review row ids, Stage 105 source follow-up map entry ids, Stage 105
...
- focused frontend model tests proving evidence-check review path steps derive
  from Stage 106 static evidence-check prompt cards and static citation-gap cue
  cards derive from Stage 106 citation-review lane rows;
...
- assertions that each review step carries Stage 106 through Stage 64 source
...
- existing Stage 106 through Stage 09 checks as regression coverage for touched
  surfaces;
...
- evidence-check review path steps derive from Stage 106 static evidence-check
  prompt cards and static citation-gap cue cards derive from Stage 106
...
- Stage 106 evidence-check prompt cards and citation-review lane rows, Stage
  ...
  response-prompt cards and review-path steps, Stage 96 response-map rows, Stage
  95 through Stage 64 source lineage ids, local anchors, callbacks, gaps,
...
- the mission-console panel is compact and adjacent to Stage 106 without route
